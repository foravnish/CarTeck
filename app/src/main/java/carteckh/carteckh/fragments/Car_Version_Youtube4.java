...
public class Car_Version_Youtube4 extends Fragment  {
...
//        ButterKnife.inject(this, view);
    ...
    private void UpadateUi() {
        ...
        Log.d("gfdfgdfh", Car_Version_Overview4.Video.toString());


        for (int i = 0; i < Car_Version_Overview4.Video.length(); i++) {
            try {
                final JSONObject videoInfoDataJsonObject = Car_Version_Overview4.Video.getJSONObject(i);
