 ...
 */
public class Car_Versioni_OverView4 extends Fragment {
    ...
    public void updateView() {
        ...
        if (Car_Version_Overview4.PhotoSection != null && Car_Version_Overview4.rightSideInfo != null && Car_Version_Overview4.EmiSection != null) {
            try {
                Log.d("dfgdfghdfhbd", String.valueOf(Car_Version_Overview4.PhotoSection));
//                Log.d("dfgdfghdfhbd2", String.valueOf(Car_Version_Overview4.rightSideInfo));
//                Log.d("dfgdfghdfhbd3", String.valueOf(Car_Version_Overview4.EmiSection));
                Log.d("fhgfhgfdgdfgh33","true");
                //final String toalFreeno = carOverView.RoadSideAssisData.getJSONObject("RoadSideAssisInfo").optString("HelpNo");

                final JSONObject informationJsonObject = Car_Version_Overview4.rightSideInfo.getJSONObject("Information");
                ...
                Log.d("fhgfhgfdgdfgh2",status);


                if (status.equals("Discontinued")){
                    final JSONObject emiInfoJsonObject = Car_Version_Overview4.EmiSection.getJSONObject("EmiInfo");
...
//                    price.setText(Html.fromHtml(span1));
                    ...
                    c_overview_tv_heading.setText(Car_Version_Overview4.PhotoSection.getJSONObject("Photoinfo").getString("Heading"));
                    //c_overview_tv.setText(Html.fromHtml(span));
                    c_overview_iv.setImageUrl(Car_Version_Overview4.PhotoSection.getJSONObject("Photoinfo").getString("Photo").replace(" ","%20"), imageLoader);
                }
                else {
                    final JSONObject emiInfoJsonObject = Car_Version_Overview4.EmiSection.getJSONObject("EmiInfo");
                    final String emi = emiInfoJsonObject.getString("Emi");
