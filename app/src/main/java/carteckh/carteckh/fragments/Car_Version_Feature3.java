...
public class Car_Version_Feature3 extends Fragment {
    ...
    private void UpadateUi() {
        if (Car_Version_Overview3.FeatureBlock != null) {
            try {

                if (Car_Version_Overview3.FeatureBlock.length() > 0) {


                    for (int i = 0; i < Car_Version_Overview3.FeatureBlock.length(); i++) {
                        JSONObject jsonObject = Car_Version_Overview3.FeatureBlock.getJSONObject(i);
