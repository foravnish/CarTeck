 ...
 */
public class ManageCarListing extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://www.carteckh.com/my-car-listing.php?uid=" + Constants.sharedPreferences.getString("user_id", "") + "&password=" + Constants.sharedPreferences.getString("user_pass", "") + "&loginFrom=app");
