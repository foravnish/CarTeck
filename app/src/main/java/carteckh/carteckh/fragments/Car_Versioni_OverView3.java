 ...
 */
public class Car_Versioni_OverView3 extends Fragment {
    ...
    public void updateView() {
        ...
        if (Car_Version_Overview3.PhotoSection != null && Car_Version_Overview3.rightSideInfo != null && Car_Version_Overview3.EmiSection != null) {
            try {
                Log.d("dfgdfghdfhbd", String.valueOf(Car_Version_Overview3.PhotoSection));
//                Log.d("dfgdfghdfhbd2", String.valueOf(Car_Version_Overview3.rightSideInfo));
//                Log.d("dfgdfghdfhbd3", String.valueOf(Car_Version_Overview3.EmiSection));
                ...
                final JSONObject informationJsonObject = Car_Version_Overview3.rightSideInfo.getJSONObject("Information");
                ...
                if (status.equals("Discontinued")){
                    final JSONObject emiInfoJsonObject = Car_Version_Overview3.EmiSection.getJSONObject("EmiInfo");
...
//                    price.setText(Html.fromHtml(span1));
                   ...
                   // String span = "<p><b>EMI: ₹ </b>" + emi + "</p><p>" + forloanOf + "</p>" + "<h6> Roadside Assistance: " + toalFreeno;
                    ...
                    c_overview_tv_heading.setText(Car_Version_Overview3.PhotoSection.getJSONObject("Photoinfo").getString("Heading"));
                    //c_overview_tv.setText(Html.fromHtml(span));
                    c_overview_iv.setImageUrl(Car_Version_Overview3.PhotoSection.getJSONObject("Photoinfo").getString("Photo").replace(" ","%20"), imageLoader);
                }
                else {
                    final JSONObject emiInfoJsonObject = Car_Version_Overview3.EmiSection.getJSONObject("EmiInfo");
                    final String emi = emiInfoJsonObject.getString("Emi");
