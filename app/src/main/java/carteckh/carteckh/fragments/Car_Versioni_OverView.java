 ...
 */
public class Car_Versioni_OverView extends Fragment {
    ...
    public void updateView() {
        ...
        if (Car_Version_Overview.PhotoSection != null && Car_Version_Overview.rightSideInfo != null && Car_Version_Overview.EmiSection != null) {
            try {
                final String toalFreeno = carOverView.RoadSideAssisData.getJSONObject("RoadSideAssisInfo").optString("HelpNo");
                final JSONObject informationJsonObject = Car_Version_Overview.rightSideInfo.getJSONObject("Information");
                ...
                Log.d("fgdfghdf",status);
                if (status.equals("Discontinued")){
                    final JSONObject emiInfoJsonObject = Car_Version_Overview.EmiSection.getJSONObject("EmiInfo");
...
//                    price.setText(Html.fromHtml(span1));
                    ...
                    c_overview_tv_heading.setText(Car_Version_Overview.PhotoSection.getJSONObject("Photoinfo").getString("Heading"));
                    //c_overview_tv.setText(Html.fromHtml(span));
                    c_overview_iv.setImageUrl(Car_Version_Overview.PhotoSection.getJSONObject("Photoinfo").getString("Photo").replace(" ","%20"), imageLoader);
                }
                else {
                    final JSONObject emiInfoJsonObject = Car_Version_Overview.EmiSection.getJSONObject("EmiInfo");
                    final String emi = emiInfoJsonObject.getString("Emi");
