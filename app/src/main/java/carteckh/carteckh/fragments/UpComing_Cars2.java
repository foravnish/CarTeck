 ...
 */
public class UpComing_Cars2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dialog = new Dialog(UpComing_Cars2.this.getActivity());
...
//        });
        ...
        Log.d("dfgdfghdf",getArguments().getString("val"));
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.Url + "task=UpcomingCar&brand_id="+getArguments().getString("val")+"&checkshort_by=", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Constants.exitdialog(dialog);
                RoadAssistance.clear();
    ...
    class Adapter extends BaseAdapter {
        ...
        Adapter() {
            inflater = (LayoutInflater) UpComing_Cars2.this.getActivity().getBaseContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
