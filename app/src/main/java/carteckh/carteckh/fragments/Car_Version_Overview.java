 ...
 */
public class Car_Version_Overview extends Fragment{
...
//        tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.d("globalstate",Constants.sharedPreferences.getString("state_id",""));
...
//    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Car_Versioni_OverView(), "OverView");
        adapter.addFrag(new Car_Version_Photo(), "Photos");
        adapter.addFrag(new Car_Version_Colors(), "Colour");
        adapter.addFrag(new Car_Version_Summary(), "Summary");
        adapter.addFrag(new Car_Version_Specification(), "Specification");
        adapter.addFrag(new Car_Version_Feature(), "Features");
        if (Video!=null) {
            adapter.addFrag(new Car_Version_Youtube(), "Videos");
        }
