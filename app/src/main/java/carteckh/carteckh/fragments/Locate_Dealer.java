 ...
 */
public class Locate_Dealer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dialog = new Dialog(Locate_Dealer.this.getActivity());
...
//        spin_brand.setAdapter(adapter_state);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.Url + "task=StateList", null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                Log.d("dfghfhfg",jsonObject.toString());
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spin_state.getSelectedItemPosition() == 0) {
                    ...
                    fragment = new LocateDealer();
                    Bundle bundle = new Bundle();
                    bundle.putString("brand_id", Brand.get(spin_brand.getSelectedItemPosition()).getStr_Brandid());
...
//                        bundle.putBoolean("status", false);
                    ...
                    FragmentManager fragmentManager = getFragmentManager();
                    fragmentManager.beginTransaction().addToBackStack(null).replace(R.id.container, fragment).commit();
                    onItemClicks.itemClick("Dealers");
                }
            }
...
//        });
    ...
    private void BrandList() {
        ...
        JsonObjectRequest jsonObjectRequest1 = new JsonObjectRequest(Request.Method.GET, Constants.Url + "task=sortBrandForDealerServiceCenter&stateId=" + state_idvalue + "&brandFor=Dealer", null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                try {
                    jsonObject2 = jsonObject.getJSONObject("sortBrandList");
                ...
                if (jsonObject2.optString("success").equals("1")) {
                    ...
                    JSONArray jsonArray = jsonObject2.optJSONArray("brandList");
...
//                            Brand.add(new Constants(jsonObject11.optString("getBrandId "),null));
//                            Brand.add(new Constants(jsonObject11.optString("getBrandName"),null));
//                            Collections.sort(Brand_Names);
    ...
    class Adapter extends BaseAdapter {
        ...
        Adapter() {
            inflater = (LayoutInflater) Locate_Dealer.this.getActivity().getBaseContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
    ...
    void GettingData() {
            final StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.Url + "task=Count_List_Brand&listfor=dealer_list"+"&state="+state_idvalue, new Response.Listener<String>() {
            @Override
