 ...
 */
public class CarOverView2 extends Fragment {
...
//                    Log.d("gdfgdfghdfh1",BrandModelName);
//                    Log.d("gdfgdfghdfh2",PhotoSection.toString());
//                    Log.d("gdfgdfghdfh3",PhotoListInterior.toString());
//                    Log.d("gdfgdfghdfh4",PhotoListExterior.toString());
//                    Log.d("gdfgdfghdfh5",rightSideInfo.toString());
//
//                    Log.d("gdfgdfghdfh6",EmiSection.toString());
//                    Log.d("gdfgdfghdfh7",VersionListData.toString());
//                    Log.d("gdfgdfghdfh8",DiscontiVersionListData.toString());
//                    Log.d("gdfgdfghdfh9",RoadSideAssisData.toString());
//                    Log.d("gdfgdfghdfh10",jsonObject.toString());
...
//                    return true;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new C_OverView2(), "OverView");

//        if (VersionListData!=null && DiscontiVersionListData!=null) {
//            adapter.addFrag(new C_Version(), "Versions");
//        }
        if (EmiSection!=null) {
            adapter.addFrag(new C_Version2(), "Versions");
        }
        if (DiscontiVersionListData!=null) {
            adapter.addFrag(new Car_Dis_Version2(), "Discontinued Versions");
        }
        if (EmiSection != null) {

            adapter.addFrag(new C_Features2(), "Summary");
        ...
        if (PhotoListInterior != null || PhotoListExterior != null) {
            ...
            adapter.addFrag(new C_Photoes2(), "Photos");
        }
        adapter.addFrag(new C_Colors2(), "Colours");

        if(VideoData != null) {
            adapter.addFrag(new Videos2(), "Videos");
        }
//        if (ReviewData != null) {
