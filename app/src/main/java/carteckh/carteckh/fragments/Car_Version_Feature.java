...
public class Car_Version_Feature extends Fragment {
    ...
    private void UpadateUi() {
        if (Car_Version_Overview.FeatureBlock != null) {
            try {

                if (Car_Version_Overview.FeatureBlock.length() > 0) {


                    for (int i = 0; i < Car_Version_Overview.FeatureBlock.length(); i++) {
                        JSONObject jsonObject = Car_Version_Overview.FeatureBlock.getJSONObject(i);
