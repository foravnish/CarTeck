...
public class Car_Version_Specification extends Fragment {
    ...
    public Car_Version_Specification() {
    ...
    private void UpadateUi() {
        if (Car_Version_Overview.specificationBlock != null) {
            try {

                if (Car_Version_Overview.specificationBlock.length() > 0) {


                    for (int i = 0; i < Car_Version_Overview.specificationBlock.length(); i++) {

                        JSONObject jsonObject = Car_Version_Overview.specificationBlock.getJSONObject(i);
