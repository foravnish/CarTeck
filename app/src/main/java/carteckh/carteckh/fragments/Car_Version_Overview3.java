 ...
 */
public class Car_Version_Overview3 extends Fragment{
...
//    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Car_Versioni_OverView3(), "OverView");
        adapter.addFrag(new Car_Version_Photo3(), "Photos");
        adapter.addFrag(new Car_Version_Colors3(), "Colour");
        adapter.addFrag(new Car_Version_Summary3(), "Summary");
        adapter.addFrag(new Car_Version_Specification3(), "Specification");
        adapter.addFrag(new Car_Version_Feature3(), "Features");
        if (Video!=null) {
            adapter.addFrag(new Car_Version_Youtube3(), "Videos");
        }
