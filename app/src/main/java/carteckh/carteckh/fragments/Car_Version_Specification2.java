...
public class Car_Version_Specification2 extends Fragment {
    ...
    public Car_Version_Specification2() {
    ...
    private void UpadateUi() {
        if (Car_Version_Overview2.specificationBlock != null) {
            try {

                if (Car_Version_Overview2.specificationBlock.length() > 0) {


                    for (int i = 0; i < Car_Version_Overview2.specificationBlock.length(); i++) {

                        JSONObject jsonObject = Car_Version_Overview2.specificationBlock.getJSONObject(i);
