...
/**
 * Created by developer on 28-Nov-15.
 */
public class Choices extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dialog = new Dialog(Choices.this.getActivity());

        //remove the title of dialog
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        view = inflater.inflate(R.layout.choices, container, false);
        ButterKnife.inject(this, view);

        text.setText("Carteckh's Choice");
        ...
        search_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!search_edit.getText().toString().equals("")) {
                    JsonObjectRequest jsonObjectRequest2 = new JsonObjectRequest(Request.Method.GET, Constants.Url + "task=CarTeckhChoiceSearch" + "&searchkeyword=" + search_edit.getText().toString(), null, new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject jsonObject) {
                            ...
                            if (jsonObject.optString("success").equals("1")) {
                                ...
                                JSONArray jsonArray = jsonObject.optJSONArray("carteckh_choice_search");
...
//                Crouton.makeText(getActivity(), "" + "Some problem occured pls try again"(), Style.ALERT).show();
                ...
                {
                    JsonObjectRequest jsonObjectRequest2 = new JsonObjectRequest(Request.Method.GET, Constants.Url + "task=CarTeckhChoiceSearch", null, new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject jsonObject) {
                            Constants.exitdialog(dialog);
                            RoadAssistance.clear();
...
//        });
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.Url + "task=Carteckh_Choice_Search", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Constants.exitdialog(dialog);
                RoadAssistance.clear();
...
//                Crouton.makeText(getActivity(), "" + "Some problem occured pls try again"(), Style.ALERT).show();
    ...
    class Adapter extends BaseAdapter {
        ...
        Adapter() {
            inflater = (LayoutInflater) Choices.this.getActivity().getBaseContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.tv_readmore.setTypeface(typeface);


            viewHolder.tv_title.setText("" + RoadAssistance.get(position).getStr_BrandName().toString());
           viewHolder.tv_ans.setText("" + Html.fromHtml(RoadAssistance.get(position).str_roadsideNumber.toString()));
            viewHolder.tv_postby1.setText("" + RoadAssistance.get(position).str_icon.toString());
            ...
            viewHolder.tv_readmore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.Url + "task=View_Counter&id=" + RoadAssistance.get(pos).getStr_Brandid().toString() + "&tbl=2", null, new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject jsonObject) {
                            ...
                            if (jsonObject.optString("success").equals("1")) {
                               ...
                               onItemClicks.itemClick("fullview");
                            }
