...
public class Car_Version_Specification4 extends Fragment {
    ...
    public Car_Version_Specification4() {
    ...
    private void UpadateUi() {
        if (Car_Version_Overview4.specificationBlock != null) {
            try {

                if (Car_Version_Overview4.specificationBlock.length() > 0) {


                    for (int i = 0; i < Car_Version_Overview4.specificationBlock.length(); i++) {

                        JSONObject jsonObject = Car_Version_Overview4.specificationBlock.getJSONObject(i);
