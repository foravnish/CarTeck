...
public class ResponseList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://www.carteckh.com/my-car-response.php?id=" + Constants.sharedPreferences.getString("user_id", "") + "&password=" + Constants.sharedPreferences.getString("user_pass", "") + "&loginFrom=app");
