...
public class Car_Version_Summary3 extends Fragment {
    ...
    private void UpadateUi() {
        if (Car_Version_Overview3.SummaryBlock != null) {
            try {

                //if (Car_Version_Overview3.SummaryBlock.length() > 0) {
                Log.d("fgdgdfgdfg",Car_Version_Overview3.SummaryBlock.toString());

                for (int i = 0; i < Car_Version_Overview3.SummaryBlock.length(); i++) {


                    final JSONObject jsonObject = Car_Version_Overview3.SummaryBlock.getJSONObject(i);
