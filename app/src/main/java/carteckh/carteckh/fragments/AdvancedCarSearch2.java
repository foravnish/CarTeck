 ...
 */
public class AdvancedCarSearch2 extends Fragment {
...
//    SwipeMenuListView grid_view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dialog = new Dialog(AdvancedCarSearch2.this.getActivity());
...
//        });
        ...
        grid_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Fragment fragment = new Car_Version_Overview4();
...
//                    map.put("body_type", getArguments().getString("body_type"));
                    ...
                    map.put("amount", Constants.sharedPreferences.getString("amount1",""));
                    map.put("fuel_type", Constants.sharedPreferences.getString("fuel_type1",""));
                    map.put("seats_type", String.valueOf(getArguments().getString("seats_type")));
                    map.put("transmission_type", Constants.sharedPreferences.getString("transmission_type1",""));
                    map.put("engine_displacement", Constants.sharedPreferences.getString("engine_displacement1",""));
                    map.put("brands", Constants.sharedPreferences.getString("brands1",""));
                    map.put("body_type", Constants.sharedPreferences.getString("body_type1",""));



                    Log.d("amount1", getArguments().getString("minamount"));
       ...
       view.setFocusableInTouchMode(true);
        ...
        view.setOnKeyListener( new View.OnKeyListener()
        {
            ...
            public boolean onKey( View v, int keyCode, KeyEvent event )
            {
                ...
                {
//                    String[] arr=getArguments().getStringArray("pricerange");
//                    Log.d("dfdgdgdfgdfg", String.valueOf(getArguments().getStringArray("pricerange")));
//                    AdvanceFilter.pricerange.setSelection(arr);
                    Fragment fragment = new AdvanceFilter();
                    FragmentManager fragmentManager = getFragmentManager();
    ...
    class Adapter extends BaseAdapter {
        ...
        Adapter() {
            inflater = (LayoutInflater) AdvancedCarSearch2.this.getActivity().getBaseContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
