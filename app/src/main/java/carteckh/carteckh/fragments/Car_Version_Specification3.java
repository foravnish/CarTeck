...
public class Car_Version_Specification3 extends Fragment {
    ...
    public Car_Version_Specification3() {
    ...
    private void UpadateUi() {
        if (Car_Version_Overview3.specificationBlock != null) {
            try {

                if (Car_Version_Overview3.specificationBlock.length() > 0) {


                    for (int i = 0; i < Car_Version_Overview3.specificationBlock.length(); i++) {

                        JSONObject jsonObject = Car_Version_Overview3.specificationBlock.getJSONObject(i);
